...
echo "HAL9000: Flashing filesystem '${FIRMWARE_VERSION}' on '${HAL9000_ARDUINO_ID}'..."
...
case "${HAL9000_ARDUINO_MCU}" in
	"RP2040")
		...
		"${GIT_DIR}/resources/downloads/picotool" load --verify \
		                                          "${GIT_DIR}/resources/downloads/${HAL9000_ARDUINO_ID}_littlefs_${FIRMWARE_VERSION}.bin" \
	...
	"ESP32")
		...
		"${GIT_DIR}/resources/downloads/esptool" --chip esp32 --port "/dev/ttyHAL9000" --baud 460800 \
		                                         ...
		                                         0x200000 "${GIT_DIR}/resources/downloads/${HAL9000_ARDUINO_ID}_littlefs_${FIRMWARE_VERSION}.bin"
		;;
esac
